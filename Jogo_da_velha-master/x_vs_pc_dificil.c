...
//Este arquivo tem a principal função de ser o jogo do jogador como X contra CPU no dificil, sendo igual ao medio porém com mais condição

void x_vs_pc_rounds_dificil(char velha[3][3], char amostrador[3][3], char nomeplayer[10], int qual_round){
    system("cls");
    setlocale(LC_ALL, "Portuguese");
    srand(time(0));

    if(qual_round == 1 || qual_round == 3 || qual_round == 5 || qual_round == 7 || qual_round == 9)     {system("color 0A");}
     ...
     if(qual_round == 1 || qual_round == 3 || qual_round == 5 || qual_round == 7 || qual_round == 9)   {printf("||                Vez do X:                           ||\n");}
        ...
        if(qual_round == 2 || qual_round == 4 || qual_round == 6 || qual_round == 8){
            ...
            if(velha[linha][coluna] == 'X' || velha[linha][coluna] == 'O'){
                printf("\n > > POSIÇÃO INVALIDA!! < <\n");
                system("pause");
                x_vs_pc_rounds_dificil(velha, amostrador, nomeplayer, qual_round);}
                ...
                if(qual_round == 2 || qual_round == 4 || qual_round == 6 || qual_round == 8){
                    ...
                    //--------------------------------------------------------------------------
                    else if(velha[0][0] == 'X' && velha[0][1] == 'X' && velha[0][2] == NULL){ linha = 0; coluna = 2;}
