...
O artigo de \citeonline{zoubir2021crack}, apresenta uma comparação interessante entre modelos de redes neurais convolucionais. Segundo o autor, utilizar \textit{Deep Learning} a partir de redes neurais convolucionais são melhores que os métodos padrões de processamento de imagens por conta se superar suas limitações. % Ele não fala a limitação rs

Porém, um grande problema enfrentado por esse método é a de treinar esses modelos por conta da necessidade de uma base de dados robusta, como exemplo são citados as bases de dados de \citeonline{yang2017deep}, \citeonline{maguire2018sdnet2018}, \citeonline{mundt2019meta} e \citeonline{xu2019automatic}.
...
Verificar o trabalho de \citeonline{dung2019autonomous}

\subsection{Arquitetura YOLO v5}
% Contextualização do modelo YOLO v5


% Trabalho Correlato que utiliza YOLO v5

\citeonline{mishra2022two}, compara yolo e resnet

\subsection{Arquitetura CrackNet}
% Contextualização do modelo CrackNet


% Trabalho Correlato que utiliza CrackNet

\citeonline{zhou2020concrete}


\subsection{Fully convolutional networks}
% Contextualização do modelo FCN


% Trabalho Correlato que utiliza FCN
\citeonline{narazaki2021synthetic}, utiliza deste modelo computacional em seu trabalho.



\subsection{Arquitetura U-net}
% Contextualização do modelo Unet


% Trabalho Correlato que utiliza Unet
No trabalho de \citeonline{liu2019computer}

\subsection{SegNet}

% Contextualização do modelo SegNet


% Trabalho Correlato que utiliza SegNet
Um exemplo deste modelo pode ser visualizado no trabalho de \citeonline{liang2019image}
